"""Host-runtime discovery for Pyrefly sandbox compatibility."""
...
class PyreflyRuntimeDiscovery(RuntimeDiscovery):
    """Expose the host Pyrefly launcher and supporting runtime read-only.

    Pyrefly is resolved before Bubblewrap is created. If the host executable is
